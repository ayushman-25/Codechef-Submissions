...
max_tests=5000 # change it accordingly
diff_found=0
...
do
	...
	python3 generator.py > input1.txt

	# run original solution, take input from above generated test case i.e. from input1.txt
	# and save it in original_output.txt

	./solution < input1.txt > original_output.txt
	# python3 solution.py < input1.txt > original_output.txt
